...
function renderHistoricalContext() {
    ...
    var bearAvgDur = bearTier.avg_duration_days ? formatDuration(bearTier.avg_duration_days) : '14 months';
    ...
    html += '<div style="font-size: 14px; color: #64748b; line-height: 1.7;">Average decline: <strong style="color: #0f172a; font-size: 16px;">-36%</strong><br/>Average duration: <strong style="color: #0f172a;">' + bearAvgDur + '</strong><br/>Typical duration: <strong style="color: #0f172a;">' + formatDuration(bearTier.median_duration_days || 294) + '</strong> (median)</div>';
    html += '</div>';
    html += '</div>';
